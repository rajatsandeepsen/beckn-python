...
class GetRatingCategoriesContext(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('get_rating_categories',):
            raise ValueError("must be one of enum values ('get_rating_categories')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRatingCategoriesContext:
        """Create an instance of GetRatingCategoriesContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRatingCategoriesContext:
        """Create an instance of GetRatingCategoriesContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRatingCategoriesContext.parse_obj(obj)

        _obj = GetRatingCategoriesContext.parse_obj({
