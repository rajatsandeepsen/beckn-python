...
class RatingCategoriesContext(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('rating_categories',):
            raise ValueError("must be one of enum values ('rating_categories')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RatingCategoriesContext:
        """Create an instance of RatingCategoriesContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RatingCategoriesContext:
        """Create an instance of RatingCategoriesContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RatingCategoriesContext.parse_obj(obj)

        _obj = RatingCategoriesContext.parse_obj({
