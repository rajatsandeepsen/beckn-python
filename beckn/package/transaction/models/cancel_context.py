...
class CancelContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelContext:
        """Create an instance of CancelContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelContext:
        """Create an instance of CancelContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelContext.parse_obj(obj)

        _obj = CancelContext.parse_obj({
