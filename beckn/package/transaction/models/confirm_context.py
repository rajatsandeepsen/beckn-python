...
class ConfirmContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfirmContext:
        """Create an instance of ConfirmContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfirmContext:
        """Create an instance of ConfirmContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfirmContext.parse_obj(obj)

        _obj = ConfirmContext.parse_obj({
