...
class InitContext(BaseModel):
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in ('init',):
            raise ValueError("must be one of enum values ('init')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InitContext:
        """Create an instance of InitContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InitContext:
        """Create an instance of InitContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InitContext.parse_obj(obj)

        _obj = InitContext.parse_obj({
