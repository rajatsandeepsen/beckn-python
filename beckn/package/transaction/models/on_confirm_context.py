...
class OnConfirmContext(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_confirm',):
            raise ValueError("must be one of enum values ('on_confirm')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnConfirmContext:
        """Create an instance of OnConfirmContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnConfirmContext:
        """Create an instance of OnConfirmContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnConfirmContext.parse_obj(obj)

        _obj = OnConfirmContext.parse_obj({
