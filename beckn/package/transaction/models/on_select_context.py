...
class OnSelectContext(BaseModel):
    """
    OnSelectContext
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_select',):
            raise ValueError("must be one of enum values ('on_select')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnSelectContext:
        """Create an instance of OnSelectContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnSelectContext:
        """Create an instance of OnSelectContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnSelectContext.parse_obj(obj)

        _obj = OnSelectContext.parse_obj({
