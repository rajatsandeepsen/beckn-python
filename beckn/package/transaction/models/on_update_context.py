...
class OnUpdateContext(BaseModel):
    """
    OnUpdateContext
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_update',):
            raise ValueError("must be one of enum values ('on_update')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnUpdateContext:
        """Create an instance of OnUpdateContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnUpdateContext:
        """Create an instance of OnUpdateContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnUpdateContext.parse_obj(obj)

        _obj = OnUpdateContext.parse_obj({
