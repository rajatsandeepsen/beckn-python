...
class Rating2Context(BaseModel):
    """
    Rating2Context
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in ('rating',):
            raise ValueError("must be one of enum values ('rating')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Rating2Context:
        """Create an instance of Rating2Context from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Rating2Context:
        """Create an instance of Rating2Context from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Rating2Context.parse_obj(obj)

        _obj = Rating2Context.parse_obj({
