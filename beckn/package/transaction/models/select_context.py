...
class SelectContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SelectContext:
        """Create an instance of SelectContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SelectContext:
        """Create an instance of SelectContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SelectContext.parse_obj(obj)

        _obj = SelectContext.parse_obj({
