...
class Support2Context(BaseModel):
    """
    Support2Context
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in ('support',):
            raise ValueError("must be one of enum values ('support')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Support2Context:
        """Create an instance of Support2Context from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Support2Context:
        """Create an instance of Support2Context from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Support2Context.parse_obj(obj)

        _obj = Support2Context.parse_obj({
