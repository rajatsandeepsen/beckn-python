...
class TrackContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrackContext:
        """Create an instance of TrackContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrackContext:
        """Create an instance of TrackContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrackContext.parse_obj(obj)

        _obj = TrackContext.parse_obj({
