...
class UpdateContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateContext:
        """Create an instance of UpdateContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateContext:
        """Create an instance of UpdateContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateContext.parse_obj(obj)

        _obj = UpdateContext.parse_obj({
