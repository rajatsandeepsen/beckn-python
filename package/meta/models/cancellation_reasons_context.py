...
class CancellationReasonsContext(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in ('cancellation_reasons',):
            raise ValueError("must be one of enum values ('cancellation_reasons')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancellationReasonsContext:
        """Create an instance of CancellationReasonsContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancellationReasonsContext:
        """Create an instance of CancellationReasonsContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancellationReasonsContext.parse_obj(obj)

        _obj = CancellationReasonsContext.parse_obj({
