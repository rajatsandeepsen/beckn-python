...
class GetCancellationReasonsContext(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('get_cancellation_reasons',):
            raise ValueError("must be one of enum values ('get_cancellation_reasons')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCancellationReasonsContext:
        """Create an instance of GetCancellationReasonsContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCancellationReasonsContext:
        """Create an instance of GetCancellationReasonsContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCancellationReasonsContext.parse_obj(obj)

        _obj = GetCancellationReasonsContext.parse_obj({
