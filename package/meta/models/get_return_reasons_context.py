...
class GetReturnReasonsContext(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('get_return_reasons',):
            raise ValueError("must be one of enum values ('get_return_reasons')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReturnReasonsContext:
        """Create an instance of GetReturnReasonsContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReturnReasonsContext:
        """Create an instance of GetReturnReasonsContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetReturnReasonsContext.parse_obj(obj)

        _obj = GetReturnReasonsContext.parse_obj({
