...
class InlineObject(BaseModel):
    ...
    InlineObject
    """
    message: InlineObjectMessage = Field(...)
    error: Optional[Error] = None
    __properties = ["message", "error"]
    ...
    def from_dict(cls, obj: dict) -> InlineObject:
        ...
        _obj = InlineObject.parse_obj({
            "message": InlineObjectMessage.from_dict(obj.get("message")) if obj.get("message") is not None else None,
