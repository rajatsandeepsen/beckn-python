...
class ReturnReasonsContext(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in ('return_reasons',):
            raise ValueError("must be one of enum values ('return_reasons')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReturnReasonsContext:
        """Create an instance of ReturnReasonsContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReturnReasonsContext:
        """Create an instance of ReturnReasonsContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReturnReasonsContext.parse_obj(obj)

        _obj = ReturnReasonsContext.parse_obj({
