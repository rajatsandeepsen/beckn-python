...
class OnCancelContext(BaseModel):
    """
    OnCancelContext
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_cancel',):
            raise ValueError("must be one of enum values ('on_cancel')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnCancelContext:
        """Create an instance of OnCancelContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnCancelContext:
        """Create an instance of OnCancelContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnCancelContext.parse_obj(obj)

        _obj = OnCancelContext.parse_obj({
