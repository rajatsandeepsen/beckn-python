...
class OnInitContext(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_init',):
            raise ValueError("must be one of enum values ('on_init')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnInitContext:
        """Create an instance of OnInitContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnInitContext:
        """Create an instance of OnInitContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnInitContext.parse_obj(obj)

        _obj = OnInitContext.parse_obj({
