...
class OnRatingContext(BaseModel):
    """
    OnRatingContext
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_rating',):
            raise ValueError("must be one of enum values ('on_rating')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnRatingContext:
        """Create an instance of OnRatingContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnRatingContext:
        """Create an instance of OnRatingContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnRatingContext.parse_obj(obj)

        _obj = OnRatingContext.parse_obj({
