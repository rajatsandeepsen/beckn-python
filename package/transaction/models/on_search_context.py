...
class OnSearchContext(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_search',):
            raise ValueError("must be one of enum values ('on_search')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnSearchContext:
        """Create an instance of OnSearchContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnSearchContext:
        """Create an instance of OnSearchContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnSearchContext.parse_obj(obj)

        _obj = OnSearchContext.parse_obj({
