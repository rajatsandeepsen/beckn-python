...
class OnStatusContext(BaseModel):
    """
    OnStatusContext
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_status',):
            raise ValueError("must be one of enum values ('on_status')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnStatusContext:
        """Create an instance of OnStatusContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnStatusContext:
        """Create an instance of OnStatusContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnStatusContext.parse_obj(obj)

        _obj = OnStatusContext.parse_obj({
