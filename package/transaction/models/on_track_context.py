...
class OnTrackContext(BaseModel):
    """
    OnTrackContext
    """
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('on_track',):
            raise ValueError("must be one of enum values ('on_track')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OnTrackContext:
        """Create an instance of OnTrackContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OnTrackContext:
        """Create an instance of OnTrackContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OnTrackContext.parse_obj(obj)

        _obj = OnTrackContext.parse_obj({
