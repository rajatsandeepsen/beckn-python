...
class SearchContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchContext:
        """Create an instance of SearchContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchContext:
        """Create an instance of SearchContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchContext.parse_obj(obj)

        _obj = SearchContext.parse_obj({
