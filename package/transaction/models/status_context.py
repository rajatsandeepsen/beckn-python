...
class StatusContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StatusContext:
        """Create an instance of StatusContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StatusContext:
        """Create an instance of StatusContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StatusContext.parse_obj(obj)

        _obj = StatusContext.parse_obj({
